    ...
    <div className="bg-white rounded-none border border-gray-200 shadow-sm flex flex-col">
      ...
      <ul className="divide-y divide-gray-100">
        {billings.map((b) => (
          <li
            key={b.id}
            className="grid grid-cols-[1fr_80px_170px_100px] items-center px-6 py-4 hover:bg-gray-50 transition-colors"
          >
        ...
        {billings.length < PAGE_SIZE &&
          Array.from({ length: PAGE_SIZE - billings.length }).map((_, i) => (
            <li key={`empty-${i}`} className="grid grid-cols-[1fr_80px_170px_100px] items-center px-6 py-4">
